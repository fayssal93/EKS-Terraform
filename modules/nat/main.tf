...
# ajout d'une route dans la table de route prive 1 qui envoie le traffic vers la nat gateway
...
# ajout d'une route dans la table de route prive 2 qui envoie le traffic vers la nat gateway
resource "aws_route" "private2_subnet_route"{
    route_table_id = var.rt_devops_private2_id
    destination_cidr_block = "0.0.0.0/0"
